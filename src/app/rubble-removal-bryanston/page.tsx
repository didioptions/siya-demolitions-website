...
const faqs = [
    {
        ...
        answer: "We are experts in operating within the secure estates of Bryanston. Our process involves direct coordination with estate management to ensure full compliance with their rules on work hours, noise, and vehicle access. Our teams are professional, discreet, and take great care to protect paving, landscaping, and other property features."
    },
    {
        question: "Can you provide a fast rubble removal service for a renovation in Bryanston?",
        answer: "Yes, we provide a rapid and affordable service for homeowners in Bryanston. Whether you're clearing debris from a kitchen renovation, a garden cleanup, or a small DIY project, we can typically schedule a same-day or next-day collection."
    },
    {
        question: "Is your rubble removal service licensed for work in the Bryanston area?",
        answer: "Absolutely. We are a fully licensed waste carrier with the City of Johannesburg, ensuring all rubble from your Bryanston property will be transported and disposed of legally and responsibly at a registered facility. This protects you from the risk of fines for illegal dumping."
    }
];
  ...
  return (
    <div className="container mx-auto px-4 py-12 md:px-6 md:py-20">
        <section className="text-center mb-16">
            <h1 className="text-4xl md:text-5xl font-bold tracking-tight">Rubble Removal Services Bryanston</h1>
            <p className="mt-3 max-w-3xl mx-auto text-muted-foreground">
                Keep your project in Bryanston moving with fast, professional, and licensed rubble removal from SIMA Demolitions Projects. We specialize in serving secure lifestyle estates and commercial developments with a discreet, efficient, and fully compliant service.
            </p>
        ...
        <section id="services" className="mb-16">
            <h2 className="text-3xl font-bold text-center mb-12">Professional Rubble Removal Services in Bryanston</h2>
            <div className="grid md:grid-cols-2 gap-8 items-center">
                 <div>
                    {servicesImage && <div className="aspect-video relative"><Image src={servicesImage.imageUrl} alt="Site clearing in a Bryanston estate" data-ai-hint="site clearing bryanston" fill className="rounded-lg object-cover" /></div>}
                </div>
                <div>
                    <p className="text-muted-foreground mb-4">Specialized solutions for the Bryanston area.</p>
        ...
        <section id="faq" className="max-w-4xl mx-auto mb-16">
            <h2 className="text-3xl font-bold text-center mb-8">FAQ About Rubble Removal in Bryanston</h2>
        ...
        <section className="text-center bg-primary text-primary-foreground p-8 rounded-lg relative overflow-hidden">
            {clearedSiteImage && <Image src={clearedSiteImage.imageUrl} alt="Pristine site after rubble removal in Bryanston" data-ai-hint="clean site bryanston" fill className="object-cover opacity-20" />}
            <div className="relative z-10">
                <h2 className="text-3xl font-bold">Get Your Bryanston Property Cleared</h2>
                <p className="mt-2 max-w-2xl mx-auto text-primary-foreground/80">For a professional, licensed, and reliable rubble removal service in Bryanston, contact the experts at SIMA Demolitions.</p>
                <div className="mt-8 flex flex-col md:flex-row gap-4 justify-center">
