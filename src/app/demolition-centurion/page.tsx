...
const faqs = [
    { question: "Are your demolition services available throughout Centurion?", answer: "Yes, we serve all neighborhoods in Centurion, from Irene to Highveld. We provide fast, local service across the area." },
    { question: "What kind of projects do you handle in Centurion?", answer: "We handle everything from residential home demolition and pool removals to site clearing for new commercial developments near Centurion Mall and other local landmarks." },
    { question: "How do you manage dust and noise during demolition?", answer: "We use dust suppression techniques like water spraying and adhere to municipal work hours to minimize disruption to your Centurion neighbors." },
    { question: "Do I need a permit for demolition in Centurion?", answer: "Yes, a permit from the City of Tshwane is required. We manage the entire permit process for you as part of our service." }
];
      ...
      <div className="container mx-auto px-4 py-12 md:px-6 md:py-20">
        <section className="text-center mb-16">
          ...
          <p className="mt-4 text-lg text-accent font-semibold flex items-center justify-center gap-2">
            <ShieldCheck /> Your Local, Licensed Centurion Demolition Contractor
          </p>
          <p className="mt-3 max-w-3xl mx-auto text-muted-foreground">
            SIMA Demolitions provides expert demolition services across Centurion. As your local contractors, we specialize in safe house demolition, pool removal, and complete site clearing for homeowners and developers. We know Centurion's regulations and are committed to delivering compliant, hassle-free projects.
          </p>
        ...
        <section className="mb-16">
            <h2 className="text-3xl font-bold text-center mb-8">Specialized Demolition for Centurion Properties</h2>
            <div className="grid md:grid-cols-3 gap-6">
                ...
                <Card><CardHeader><CardTitle>Site Clearing & Rubble Removal</CardTitle></CardHeader><CardContent><p className="text-muted-foreground">Complete site preparation, including removing all demolition debris and waste, leaving your Centurion property ready for construction.</p></CardContent></Card>
            </div>
        </section>
