...
const faqs = [
    { question: "Are your demolition services available throughout Alberton?", answer: "Yes, we serve all neighborhoods in Alberton, from Meyersdal to Brackenhurst. We provide fast, local service across the area." },
    { question: "What kind of projects do you handle in Alberton?", answer: "We handle everything from residential home demolition and pool removals to site clearing for new commercial developments near Reading Country Club and other local landmarks." },
    { question: "How do you manage dust and noise during demolition?", answer: "We use dust suppression techniques like water spraying and adhere to municipal work hours to minimize disruption to your Alberton neighbors." },
    { question: "Do I need a permit for demolition in Alberton?", answer: "Yes, a permit from the City of Ekurhuleni is required. We manage the entire permit process for you as part of our service." }
];
      ...
      <div className="container mx-auto px-4 py-12 md:px-6 md:py-20">
        <section className="text-center mb-16">
          ...
          <p className="mt-3 max-w-3xl mx-auto text-muted-foreground">
            SIMA Demolitions provides expert demolition services across Alberton. As your local contractors, we specialize in safe house demolition, pool removal, and complete site clearing for homeowners and developers. We know Alberton's regulations and are committed to delivering compliant, hassle-free projects.
          </p>
        ...
        <section className="mb-16">
            ...
            <div className="grid md:grid-cols-3 gap-6">
                <Card><CardHeader><CardTitle>Home Demolition</CardTitle></CardHeader><CardContent><p className="text-muted-foreground">Safe removal of houses to make way for new builds or subdivisions. We handle projects of all sizes in areas like Alberton North and New Redruth.</p></CardContent></Card>
                ...
                <Card><CardHeader><CardTitle>Site Clearing & Rubble Removal</CardTitle></CardHeader><CardContent><p className="text-muted-foreground">Complete site preparation, including removing all demolition debris and waste, leaving your Alberton property ready for construction.</p></CardContent></Card>
            </div>
        </section>
