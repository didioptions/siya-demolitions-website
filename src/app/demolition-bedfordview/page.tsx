...
const faqs = [
    { question: "Are your demolition services available throughout Bedfordview?", answer: "Yes, we serve all neighborhoods in Bedfordview, from Senderwood to St Andrews. We provide fast, local service across the area." },
    { question: "What kind of projects do you handle in Bedfordview?", answer: "We handle everything from residential home demolition and pool removals to site clearing for new commercial developments near Eastgate Shopping Centre and other local landmarks." },
    { question: "How do you manage dust and noise during demolition?", answer: "We use dust suppression techniques like water spraying and adhere to municipal work hours to minimize disruption to your Bedfordview neighbors." },
    { question: "Do I need a permit for demolition in Bedfordview?", answer: "Yes, a permit from the City of Ekurhuleni is required. We manage the entire permit process for you as part of our service." }
];
      ...
      <div className="container mx-auto px-4 py-12 md:px-6 md:py-20">
        <section className="text-center mb-16">
          ...
          <p className="mt-4 text-lg text-accent font-semibold flex items-center justify-center gap-2">
            <ShieldCheck /> Your Local, Licensed Bedfordview Demolition Contractor
          </p>
          <p className="mt-3 max-w-3xl mx-auto text-muted-foreground">
            SIMA Demolitions provides expert demolition services across Bedfordview. As your local contractors, we specialize in safe house demolition, pool removal, and complete site clearing for homeowners and developers. We know Bedfordview's regulations and are committed to delivering compliant, hassle-free projects.
          </p>
        ...
        <section className="mb-16">
            ...
            <div className="grid md:grid-cols-3 gap-6">
                <Card><CardHeader><CardTitle>Home Demolition</CardTitle></CardHeader><CardContent><p className="text-muted-foreground">Safe removal of houses to make way for new builds or subdivisions in upscale areas like Bedford Park.</p></CardContent></Card>
                ...
                <Card><CardHeader><CardTitle>Site Clearing & Rubble Removal</CardTitle></CardHeader><CardContent><p className="text-muted-foreground">Complete site preparation, including removing all demolition debris and waste, leaving your Bedfordview property ready for construction.</p></CardContent></Card>
            </div>
        </section>

        <section className="grid md:grid-cols-5 gap-8 mb-16 items-center">
            <div className="md:col-span-3">
                <h2 className="text-3xl font-bold mb-6">Your Trusted Demolition Partner in Bedfordview</h2>
