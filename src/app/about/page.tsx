        ...
        <div>
            <section className="relative w-full h-64 md:h-80">
                ...
                <div className="relative z-10 container mx-auto px-4 md:px-6 h-full flex flex-col justify-center items-center text-center text-white">
                    <h1 className="text-4xl md:text-5xl font-bold">About Apex Demolitions Projects</h1>
            ...
            <section className="container mx-auto px-4 py-12 md:px-6 md:py-20">
                <div className="max-w-4xl mx-auto space-y-6">
                    ...
                    <p className="text-muted-foreground text-lg">
                       Apex Demolitions Projects has been serving Gauteng since 2000. Our experienced team provides reliable demolition, rubble removal, site cleaning, tree felling, and construction services for residential, commercial, and industrial clients.
                    </p>
                    <p className="text-muted-foreground text-lg">
