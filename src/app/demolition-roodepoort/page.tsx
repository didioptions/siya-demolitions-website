...
const faqs = [
    { question: "Are your demolition services available throughout Roodepoort?", answer: "Yes, we serve all neighborhoods in Roodepoort, from Helderkruin to Wilro Park. We provide fast, local service across the area." },
    { question: "What kind of projects do you handle in Roodepoort?", answer: "We handle everything from residential home demolition and pool removals to site clearing for new commercial developments near Clearwater Mall." },
    { question: "How do you manage dust and noise during demolition?", answer: "We use dust suppression techniques like water spraying and adhere to municipal work hours to minimize disruption to your Roodepoort neighbors." },
    { question: "Do I need a permit for demolition in Roodepoort?", answer: "Yes, a permit from the City of Johannesburg is required. We manage the entire permit process for you as part of our service." }
];
      ...
      <div className="container mx-auto px-4 py-12 md:px-6 md:py-20">
        <section className="text-center mb-16">
          ...
          <p className="mt-4 text-lg text-accent font-semibold flex items-center justify-center gap-2">
            <ShieldCheck /> Your Local, Licensed Roodepoort Demolition Contractor
          </p>
          <p className="mt-3 max-w-3xl mx-auto text-muted-foreground">
            SIMA Demolitions provides expert demolition services across Roodepoort. As your local contractors, we specialize in safe house demolition, pool removal, and complete site clearing for homeowners and developers. We know Roodepoort's regulations and are committed to delivering compliant, hassle-free projects.
          </p>
        ...
        <section className="mb-16">
            <h2 className="text-3xl font-bold text-center mb-8">Specialized Demolition for Roodepoort Properties</h2>
            <div className="grid md:grid-cols-3 gap-6">
                <Card><CardHeader><CardTitle>Home Demolition</CardTitle></CardHeader><CardContent><p className="text-muted-foreground">Safe removal of houses to make way for new builds or subdivisions in Roodepoort's family-friendly suburbs.</p></CardContent></Card>
                ...
                <Card><CardHeader><CardTitle>Site Clearing & Rubble Removal</CardTitle></CardHeader><CardContent><p className="text-muted-foreground">Complete site preparation, including removing all demolition debris and waste, leaving your Roodepoort property ready for construction.</p></CardContent></Card>
            </div>
        </section>
