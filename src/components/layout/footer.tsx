    ...
    <footer className="bg-card border-t text-muted-foreground">
      <div className="container mx-auto px-4 py-12 md:px-6">
          ...
          <div>
            ...
            <ul className="mt-4 space-y-3">
              ...
              <li className="flex items-center gap-3">
                ...
                <a href="mailto:info@apexdemolitions.co.za" className="text-sm hover:text-primary transition-colors">info@apexdemolitions.co.za</a>
              </li>
        ...
        <div className="mt-12 border-t pt-6 text-center text-sm">
          <p>&copy; {year} Apex Demolitions Projects. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
